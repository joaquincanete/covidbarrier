...
int TempMax=37.50; //Temperatura maxima permitida
int TpoAlarma=1000; //Tiempo de Alarma por alta temperatura
...
//Mensaje inicial
  ...
  lcd.clear();
  lcd.setCursor(0,0);
  lcd.print("ABS MONTAJES");
  lcd.setCursor(0,1);
  lcd.print("BARRERA COVID");
  lcd.setCursor(0,0);
...
switch(Presente)
{
  ...
  String msg2 = "AF:";
  String msg3 = "-";
  msg1+= String(TempObj) += msg3 += msg2 += String(counter);
  P.print (msg1),(TempObj),(msg3),(msg2),(counter);
  if(TempObj>TempMax)
  {
